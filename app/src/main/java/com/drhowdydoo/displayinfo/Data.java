...
public class Data {
    ...
    public Data(int ic1, int ic2, int ic3, int ic4, int ic_screen, String title_1, String title_2, String title_3, String title_4, String value_1, String value_2, String screenSize, int id) {
        this.ic1 = ic1;
        this.ic2 = ic2;
        this.ic3 = ic3;
        this.ic4 = ic4;
